...
extern "C" {
    #[no_mangle]
    fn fluid_voice_optimize_sample(s: *mut fluid_sample_t) -> libc::c_int;
    #[no_mangle]
    ...
    fn fluid_list_sort(
        ...
        compare_func: fluid_compare_func_t,
    ) -> *mut fluid_list_t;
    #[no_mangle]
    fn fluid_list_nth(list: *mut fluid_list_t, n: libc::c_int) -> *mut fluid_list_t;
    #[no_mangle]
    fn delete1_fluid_list(list: *mut fluid_list_t);
    #[no_mangle]
    ...
    #[no_mangle]
    fn fluid_list_prepend(list: *mut fluid_list_t, data: *mut libc::c_void) -> *mut fluid_list_t;
    #[no_mangle]
    ...
    #[no_mangle]
    fn fluid_mod_new() -> *mut fluid_mod_t;
    #[no_mangle]
    fn delete_fluid_list(list: *mut fluid_list_t);
    #[no_mangle]
    fn fluid_mod_delete(mod_0: *mut fluid_mod_t);
    #[no_mangle]
    ...
    #[no_mangle]
    fn fluid_gen_set_default_values(gen: *mut fluid_gen_t) -> libc::c_int;
    #[no_mangle]
...
pub type fluid_defsfont_t = _fluid_defsfont_t;
#[derive(Copy, Clone)]
#[repr(C)]
pub struct _fluid_defsfont_t {
...
pub type fluid_defpreset_t = _fluid_defpreset_t;
#[derive(Copy, Clone)]
#[repr(C)]
pub struct _fluid_defpreset_t {
...
pub struct _SFData {
    ...
    pub info: *mut fluid_list_t,
    pub preset: *mut fluid_list_t,
    pub inst: *mut fluid_list_t,
    pub sample: *mut fluid_list_t,
}
pub type SFVersion = _SFVersion;
#[derive(Copy, Clone)]
#[repr(C)]
pub struct _SFVersion {
    pub major: libc::c_ushort,
    pub minor: libc::c_ushort,
}
pub type SFInst = _SFInst;
#[derive(Copy, Clone)]
#[repr(C)]
pub struct _SFInst {
    pub name: [libc::c_char; 21],
    pub zone: *mut fluid_list_t,
}
pub type SFZone = _SFZone;
#[derive(Copy, Clone)]
#[repr(C)]
pub struct _SFZone {
    pub instsamp: *mut fluid_list_t,
    pub gen: *mut fluid_list_t,
    pub mod_0: *mut fluid_list_t,
}
pub type SFPreset = _SFPreset;
#[derive(Copy, Clone)]
#[repr(C)]
pub struct _SFPreset {
    pub name: [libc::c_char; 21],
...
pub type SFSample = _SFSample;
#[derive(Copy, Clone)]
#[repr(C)]
pub struct _SFSample {
    pub name: [libc::c_char; 21],
...
pub type SFGenAmount = _SFGenAmount;
#[derive(Copy, Clone)]
#[repr(C)]
pub union _SFGenAmount {
    pub sword: libc::c_short,
    pub uword: libc::c_ushort,
    pub range: C2RustUnnamed,
}
#[derive(Copy, Clone)]
#[repr(C)]
...
pub const SHDR_ID: C2RustUnnamed_1 = 28;
pub const UNKN_ID: C2RustUnnamed_1 = 0;
pub const Gen_Reserved3: C2RustUnnamed_2 = 55;
pub const Gen_Reserved2: C2RustUnnamed_2 = 49;
pub const Gen_Reserved1: C2RustUnnamed_2 = 42;
pub const Gen_Unused4: C2RustUnnamed_2 = 20;
pub const Gen_Unused3: C2RustUnnamed_2 = 19;
pub const Gen_Unused2: C2RustUnnamed_2 = 18;
pub const Gen_Unused1: C2RustUnnamed_2 = 14;
pub const Gen_Dummy: C2RustUnnamed_2 = 59;
pub const Gen_SampleId: C2RustUnnamed_2 = 53;
pub const Gen_VelRange: C2RustUnnamed_2 = 44;
pub const Gen_KeyRange: C2RustUnnamed_2 = 43;
pub const IGEN_ID: C2RustUnnamed_1 = 27;
pub const IMOD_ID: C2RustUnnamed_1 = 26;
pub const IBAG_ID: C2RustUnnamed_1 = 25;
pub const IHDR_ID: C2RustUnnamed_1 = 24;
pub const Gen_OverrideRootKey: C2RustUnnamed_2 = 58;
pub const Gen_ExclusiveClass: C2RustUnnamed_2 = 57;
pub const Gen_SampleModes: C2RustUnnamed_2 = 54;
pub const Gen_EndLoopAddrCoarseOfs: C2RustUnnamed_2 = 50;
pub const Gen_Velocity: C2RustUnnamed_2 = 47;
pub const Gen_Keynum: C2RustUnnamed_2 = 46;
pub const Gen_StartLoopAddrCoarseOfs: C2RustUnnamed_2 = 45;
pub const Gen_EndAddrCoarseOfs: C2RustUnnamed_2 = 12;
pub const Gen_StartAddrCoarseOfs: C2RustUnnamed_2 = 4;
pub const Gen_EndLoopAddrOfs: C2RustUnnamed_2 = 3;
pub const Gen_StartLoopAddrOfs: C2RustUnnamed_2 = 2;
pub const Gen_EndAddrOfs: C2RustUnnamed_2 = 1;
pub const Gen_StartAddrOfs: C2RustUnnamed_2 = 0;
pub const Gen_Instrument: C2RustUnnamed_2 = 41;
pub const PGEN_ID: C2RustUnnamed_1 = 23;
pub const PMOD_ID: C2RustUnnamed_1 = 22;
pub const PBAG_ID: C2RustUnnamed_1 = 21;
pub const PHDR_ID: C2RustUnnamed_1 = 20;
pub const PDTA_ID: C2RustUnnamed_1 = 6;
pub const LIST_ID: C2RustUnnamed_1 = 2;
pub const SMPL_ID: C2RustUnnamed_1 = 19;
pub const SDTA_ID: C2RustUnnamed_1 = 5;
pub const ICMT_ID: C2RustUnnamed_1 = 16;
pub const IVER_ID: C2RustUnnamed_1 = 11;
pub const IFIL_ID: C2RustUnnamed_1 = 7;
pub const INFO_ID: C2RustUnnamed_1 = 4;
pub const SFBK_ID: C2RustUnnamed_1 = 3;
pub const RIFF_ID: C2RustUnnamed_1 = 1;
...
unsafe extern "C" fn default_fopen(
    mut fileapi: *mut fluid_fileapi_t,
    mut path: *const libc::c_char,
) -> *mut libc::c_void {
    return libc::fopen(path, b"rb\x00" as *const u8 as *const libc::c_char) as *mut libc::c_void;
}
unsafe extern "C" fn default_fclose(mut handle: *mut libc::c_void) -> libc::c_int {
    return libc::fclose(handle as *mut libc::FILE);
}
unsafe extern "C" fn default_ftell(mut handle: *mut libc::c_void) -> libc::c_long {
...
static mut default_fileapi: fluid_fileapi_t = unsafe {
    {
        let mut init = _fluid_fileapi_t {
...
#[no_mangle]
pub unsafe extern "C" fn fluid_set_default_fileapi(mut fileapi: *mut fluid_fileapi_t) {
...
pub unsafe extern "C" fn new_fluid_defsfloader() -> *mut fluid_sfloader_t {
    ...
    loader =
        malloc(::std::mem::size_of::<fluid_sfloader_t>() as libc::c_ulong) as *mut fluid_sfloader_t;
    if loader.is_null() {
        fluid_log!(
            FLUID_ERR,
            "Out of memory",
...
pub unsafe extern "C" fn delete_fluid_defsfloader(
    ...
    if !loader.is_null() {
        free(loader as *mut libc::c_void);
    }
    return FLUID_OK as libc::c_int;
}
#[no_mangle]
pub unsafe extern "C" fn fluid_defsfloader_load(
    ...
    sfont = if !(*loader).data.is_null() {
        ...
        malloc(::std::mem::size_of::<fluid_sfont_t>() as libc::c_ulong) as *mut fluid_sfont_t
    };
    if sfont.is_null() {
        fluid_log!(
            FLUID_ERR,
...
#[no_mangle]
pub unsafe extern "C" fn fluid_defsfont_sfont_delete(mut sfont: *mut fluid_sfont_t) -> libc::c_int {
...
#[no_mangle]
pub unsafe extern "C" fn fluid_defsfont_sfont_iteration_start(mut sfont: *mut fluid_sfont_t) {
...
pub unsafe extern "C" fn new_fluid_defsfont() -> *mut fluid_defsfont_t {
    ...
    sfont =
        malloc(::std::mem::size_of::<fluid_defsfont_t>() as libc::c_ulong) as *mut fluid_defsfont_t;
    if sfont.is_null() {
        fluid_log!(
            FLUID_ERR,
            "Out of memory",
...
pub unsafe extern "C" fn delete_fluid_defsfont(mut sfont: *mut fluid_defsfont_t) -> libc::c_int {
    ...
    if !(*sfont).filename.is_null() {
        free((*sfont).filename as *mut libc::c_void);
    }
    list = (*sfont).sample;
    while !list.is_null() {
    ...
    if !(*sfont).sampledata.is_null() {
        free((*sfont).sampledata as *mut libc::c_void);
    }
    preset = (*sfont).preset;
...
#[no_mangle]
pub unsafe extern "C" fn fluid_synth_set_preset_callback(mut callback: *mut libc::c_void) {
...
pub unsafe extern "C" fn fluid_defsfont_load(
    ...
    let mut preset: *mut fluid_defpreset_t = 0 as *mut fluid_defpreset_t;
    (*sfont).filename =
        malloc((1 as libc::c_int as libc::c_ulong).wrapping_add(strlen(file))) as *mut libc::c_char;
    if (*sfont).filename.is_null() {
        fluid_log!(
            FLUID_ERR,
            "Out of memory",
...
pub unsafe extern "C" fn fluid_defsfont_load_sampledata(
    ...
    {
        perror(b"error\x00" as *const u8 as *const libc::c_char);
        fluid_log!(
            FLUID_ERR,
            "Failed to seek position in data file",
        );
        return FLUID_FAILED as libc::c_int;
    }
    (*sfont).sampledata = malloc((*sfont).samplesize as libc::c_ulong) as *mut libc::c_short;
    if (*sfont).sampledata.is_null() {
        fluid_log!(
            FLUID_ERR,
            "Out of memory",
...
pub unsafe extern "C" fn fluid_defsfont_get_sample(
    ...
    while !list.is_null() {
        ...
        if strcmp((*sample).name.as_mut_ptr(), s) == 0 as libc::c_int {
            return sample;
        }
        list = if !list.is_null() {
            (*list).next
...
pub unsafe extern "C" fn new_fluid_defpreset(
    ...
    let mut preset: *mut fluid_defpreset_t =
        malloc(::std::mem::size_of::<fluid_defpreset_t>() as libc::c_ulong)
...
pub unsafe extern "C" fn fluid_defpreset_import_sfont(
    ...
    if strlen((*sfpreset).name.as_mut_ptr()) > 0 as libc::c_int as libc::c_ulong {
        strcpy((*preset).name.as_mut_ptr(), (*sfpreset).name.as_mut_ptr());
    } else {
        libc::strcpy(
            (*preset).name.as_mut_ptr(),
            CString::new(format!("Bank{},Preset{}", (*sfpreset).bank, (*sfpreset).prenum)).unwrap().as_c_str().as_ptr()
        );
    }
...
pub unsafe extern "C" fn fluid_preset_zone_next(
    mut preset: *mut fluid_preset_zone_t,
) -> *mut fluid_preset_zone_t {
    return (*preset).next;
}
...
pub unsafe extern "C" fn new_fluid_preset_zone(
    ...
    let mut zone: *mut fluid_preset_zone_t = 0 as *mut fluid_preset_zone_t;
    zone = malloc(::std::mem::size_of::<fluid_preset_zone_t>() as libc::c_ulong)
    ...
    (*zone).next = 0 as *mut fluid_preset_zone_t;
    size = (1 as libc::c_int as libc::c_ulong).wrapping_add(strlen(name)) as libc::c_int;
    (*zone).name = malloc(size as libc::c_ulong) as *mut libc::c_char;
    if (*zone).name.is_null() {
        fluid_log!(
            FLUID_ERR,
            "Out of memory",
        );
        free(zone as *mut libc::c_void);
        return 0 as *mut fluid_preset_zone_t;
    }
...
pub unsafe extern "C" fn delete_fluid_preset_zone(
    ...
    if !(*zone).name.is_null() {
        free((*zone).name as *mut libc::c_void);
    }
...
pub unsafe extern "C" fn fluid_preset_zone_import_sfont(
        ...
        match (*sfgen).id as libc::c_int {
            ...
            _ => {
                (*zone).gen[(*sfgen).id as usize].val =
                    (*sfgen).amount.sword as fluid_real_t as libc::c_double;
    ...
    while !r.is_null() {
        ...
        (*mod_dest).amount = (*mod_src).amount as libc::c_double;
        ...
        if type_0 == 0 as libc::c_int {
            ...
            (*mod_dest).amount = 0 as libc::c_int as libc::c_double
        }
...
pub unsafe extern "C" fn new_fluid_inst() -> *mut fluid_inst_t {
    let mut inst: *mut fluid_inst_t =
        malloc(::std::mem::size_of::<fluid_inst_t>() as libc::c_ulong) as *mut fluid_inst_t;
    if inst.is_null() {
        fluid_log!(
            FLUID_ERR,
            "Out of memory",
...
pub unsafe extern "C" fn fluid_inst_import_sfont(
    ...
    let mut count: libc::c_int = 0;
    p = (*sfinst).zone;
    if strlen((*sfinst).name.as_mut_ptr()) > 0 as libc::c_int as libc::c_ulong {
        strcpy((*inst).name.as_mut_ptr(), (*sfinst).name.as_mut_ptr());
    } else {
        strcpy(
...
pub unsafe extern "C" fn new_fluid_inst_zone(
    ...
    let mut size: libc::c_int = 0;
    let mut zone: *mut fluid_inst_zone_t = 0 as *mut fluid_inst_zone_t;
    zone = malloc(::std::mem::size_of::<fluid_inst_zone_t>() as libc::c_ulong)
...
#[no_mangle]
pub unsafe extern "C" fn delete_fluid_sample(mut sample: *mut fluid_sample_t) -> libc::c_int {
    free(sample as *mut libc::c_void);
    return FLUID_OK as libc::c_int;
}

#[no_mangle]
pub unsafe extern "C" fn fluid_sample_in_rom(mut sample: *mut fluid_sample_t) -> libc::c_int {
...
pub unsafe extern "C" fn fluid_sample_import_sfont(
    mut sample: *mut fluid_sample_t,
    mut sfsample: *mut SFSample,
    mut sfont: *mut fluid_defsfont_t,
) -> libc::c_int {
    strcpy((*sample).name.as_mut_ptr(), (*sfsample).name.as_mut_ptr());
    ...
    ((*sample).sampletype & 0x10 as libc::c_int) != 0;
...
pub unsafe extern "C" fn sfload_file(
    ...
    sf = malloc(::std::mem::size_of::<SFData>() as libc::c_ulong) as *mut SFData;
    if sf.is_null() {
        fluid_log!(
            FLUID_ERR,
            "Out of memory",
    ...
    if err == 0 {
        memset(
            ...
            0 as libc::c_int,
            ::std::mem::size_of::<SFData>() as libc::c_ulong,
        );
        (*sf).fname = strcpy(
            malloc(strlen(fname).wrapping_add(1 as libc::c_int as libc::c_ulong))
                as *mut libc::c_char,
            fname,
        );
    ...
    if err == 0 && {
        ...
        fluid_log!(
            FLUID_ERR,
            "Get end of file position failed",
        );
    }
    if err == 0 {
        (*fapi).fseek.expect("non-null function pointer")(
...
unsafe extern "C" fn load_body(
    ...
    if chunkid(chunk.id) != INFO_ID as libc::c_int {
        return gerr!(
            ErrCorr,
            "Invalid ID found when expecting INFO chunk",
        );
    }
    ...
    if chunkid(chunk.id) != SDTA_ID as libc::c_int {
        return gerr!(
            ErrCorr,
            "Invalid ID found when expecting SAMPLE chunk",
        );
    }
    ...
    if chunkid(chunk.id) != PDTA_ID as libc::c_int {
        return gerr!(
            ErrCorr,
            "Invalid ID found when expecting HYDRA chunk",
        );
    }
...
unsafe extern "C" fn read_listchunk(
    ...
    if chunkid((*chunk).id) != LIST_ID as libc::c_int {
        return gerr!(
            ErrCorr,
            "Invalid chunk id in level 0 parse",
        );
    }
    if (*fapi).fread.expect("non-null function pointer")(
        &mut (*chunk).id as *mut libc::c_uint as *mut libc::c_void,
    ...
    while size > 0 as libc::c_int {
        ...
        if id as libc::c_int == IFIL_ID as libc::c_int {
            if chunk.size != 4 as libc::c_int as libc::c_uint {
                return gerr!(
                    ErrCorr,
                    "Sound font version info chunk has invalid size",
                );
            }
            ({
            ...
            if chunk.size != 4 as libc::c_int as libc::c_uint {
                return gerr!(
                    ErrCorr,
                    "ROM version info chunk has invalid size",
                );
            }
            ({
                let mut _temp: libc::c_ushort = 0;
            ...
            item = malloc(chunk.size.wrapping_add(1 as libc::c_int as libc::c_uint) as libc::c_ulong)
                as *mut libc::c_char;
            if item.is_null() {
                fluid_log!(
                    FLUID_ERR,
            ...
            *item.offset(chunk.size as isize) = '\u{0}' as i32 as libc::c_char
            ...
            return gerr!(
                ErrCorr,
                "Invalid chunk id in INFO chunk",
            );
        }
...
unsafe extern "C" fn pdtahelper(
    mut expid: libc::c_uint,
    mut reclen: libc::c_uint,
    mut chunk: *mut SFChunk,
...
unsafe extern "C" fn load_phdr(
    ...
    if size % 38 as libc::c_int != 0 || size == 0 as libc::c_int {
        return gerr!(
            ErrCorr,
            "Preset header chunk size is invalid",
        );
    }
    ...
    while i > 0 as libc::c_int {
        p = malloc(::std::mem::size_of::<SFPreset>() as libc::c_ulong) as *mut SFPreset;
        (*sf).preset = fluid_list_append((*sf).preset, p as *mut libc::c_void);
        (*p).zone = 0 as *mut fluid_list_t;
        ({
            if (*fapi).fread.expect("non-null function pointer")(
        ...
        if !pr.is_null() {
            if (zndx as libc::c_int) < pzndx as libc::c_int {
                return gerr!(
                    ErrCorr,
                    "Preset header indices not monotonic",
                );
            }
...
unsafe extern "C" fn load_pbag(
    ...
    if size % 4 as libc::c_int != 0 || size == 0 as libc::c_int {
        return gerr!(
            ErrCorr,
            "Preset bag chunk size is invalid",
        );
    }
    p = (*sf).preset;
    while !p.is_null() {
        ...
        while !p2.is_null() {
            ...
            if size < 0 as libc::c_int {
                return gerr!(
                    ErrCorr,
                    "Preset bag chunk size mismatch",
                );
            }
            z = malloc(::std::mem::size_of::<SFZone>() as libc::c_ulong) as *mut SFZone;
            (*p2).data = z as *mut libc::c_void;
            (*z).gen = 0 as *mut fluid_list_t;
            (*z).mod_0 = 0 as *mut fluid_list_t;
            ({
                let mut _temp: libc::c_ushort = 0;
                if (*fapi).fread.expect("non-null function pointer")(
                    &mut _temp as *mut libc::c_ushort as *mut libc::c_void,
            ...
            (*z).instsamp = 0 as *mut fluid_list_t;
            if !pz.is_null() {
                if (genndx as libc::c_int) < pgenndx as libc::c_int {
                    return gerr!(
                        ErrCorr,
                        "Preset bag generator indices not monotonic",
                    );
                }
                if (modndx as libc::c_int) < pmodndx as libc::c_int {
                    return gerr!(
                        ErrCorr,
                        "Preset bag modulator indices not monotonic",
                    );
                }
    ...
    if pz.is_null() {
        if genndx as libc::c_int > 0 as libc::c_int {
            fluid_log!(
                FLUID_WARN,
                "No preset generators and terminal index not 0",
            );
        }
        if modndx as libc::c_int > 0 as libc::c_int {
            fluid_log!(
                FLUID_WARN,
                "No preset modulators and terminal index not 0",
            );
        }
        return 1 as libc::c_int;
    }
        ...
        while !p2.is_null() {
            ...
            while !p3.is_null() {
                ...
                if size < 0 as libc::c_int {
                    return gerr!(
                        ErrCorr,
                        "Preset modulator chunk size mismatch",
                    );
                }
                m = malloc(::std::mem::size_of::<SFMod>() as libc::c_ulong) as *mut SFMod;
...
unsafe extern "C" fn load_pgen(
    ...
    let mut genval: SFGenAmount = _SFGenAmount { sword: 0 };
        ...
        while !p2.is_null() {
            ...
            while !p3.is_null() {
                ...
                if size < 0 as libc::c_int {
                    return gerr!(
                        ErrCorr,
                        "Preset generator chunk size mismatch",
                    );
                }
                ({
                    let mut _temp: libc::c_ushort = 0;
                ...
                if genid as libc::c_int == Gen_KeyRange as libc::c_int {
                ...
                } else if genid as libc::c_int == Gen_VelRange as libc::c_int {
                    ...
                    *fresh12 = (genval.uword as libc::c_int + 1 as libc::c_int) as libc::c_long
                        as *mut libc::c_void as *mut fluid_list_t;
                    break;
                } else {
                    level = 2 as libc::c_int;
                ...
                if skip == 0 {
                    if dup.is_null() {
                        g = malloc(::std::mem::size_of::<SFGen>() as libc::c_ulong) as *mut SFGen;
                ...
                if drop_0 == 0 {
                    ...
                    {
                        let mut _temp: *mut fluid_list_t = p3;
                        p3 = if !p3.is_null() {
                            (*p3).next
                        } else {
                            0 as *mut fluid_list_t
            ...
            if level == 3 as libc::c_int {
                ...
                if *hz != p2 {
                    let mut save: *mut libc::c_void = (*p2).data;
                    fluid_log!(
                        FLUID_WARN,
                        "Preset \"{}\": Global zone is not first zone",
                        CStr::from_ptr((*((*p).data as *const SFPreset)).name.as_ptr() as *const libc::c_char).to_str().unwrap()
                    );
                    ({
                        let mut _temp: *mut fluid_list_t = p2;
                        p2 = if !p2.is_null() {
                            (*p2).next
                        } else {
                            0 as *mut fluid_list_t
...
unsafe extern "C" fn load_ihdr(
    ...
    if size % 22 as libc::c_int != 0 || size == 0 as libc::c_int {
        return gerr!(
            ErrCorr,
            "Instrument header has invalid size",
        );
    }
    ...
    i = 0 as libc::c_int;
    while i < size {
        p = malloc(::std::mem::size_of::<SFInst>() as libc::c_ulong) as *mut SFInst;
        ...
        if !pr.is_null() {
            if (zndx as libc::c_int) < pzndx as libc::c_int {
                return gerr!(
                    ErrCorr,
                    "Instrument header indices not monotonic",
                );
            }
            i2 = zndx as libc::c_int - pzndx as libc::c_int;
            loop {
...
unsafe extern "C" fn load_ibag(
    ...
    if size % 4 as libc::c_int != 0 || size == 0 as libc::c_int {
        return gerr!(
            ErrCorr,
            "Instrument bag chunk size is invalid",
        );
    }
    p = (*sf).inst;
    while !p.is_null() {
        ...
        while !p2.is_null() {
            ...
            if size < 0 as libc::c_int {
                return gerr!(
                    ErrCorr,
                    "Instrument bag chunk size mismatch",
                );
            }
            z = malloc(::std::mem::size_of::<SFZone>() as libc::c_ulong) as *mut SFZone;
            (*p2).data = z as *mut libc::c_void;
            ...
            if !pz.is_null() {
                if (genndx as libc::c_int) < pgenndx as libc::c_int {
                    return gerr!(
                        ErrCorr,
                        "Instrument generator indices not monotonic",
                    );
                }
                if (modndx as libc::c_int) < pmodndx as libc::c_int {
                    return gerr!(
                        ErrCorr,
                        "Instrument modulator indices not monotonic",
                    );
                }
    ...
    if size != 0 as libc::c_int {
        return gerr!(
            ErrCorr,
            "Instrument chunk size mismatch",
        );
    }
    ({
        let mut _temp: libc::c_ushort = 0;
        ...
        while !p2.is_null() {
            ...
            while !p3.is_null() {
                ...
                if size < 0 as libc::c_int {
                    return gerr!(
                        ErrCorr,
                        "Instrument modulator chunk size mismatch",
                    );
                }
                m = malloc(::std::mem::size_of::<SFMod>() as libc::c_ulong) as *mut SFMod;
                (*p3).data = m as *mut libc::c_void;
    ...
    while !p.is_null() {
        ...
        while !p2.is_null() {
            ...
            while !p3.is_null() {
                ...
                } else if genid as libc::c_int == Gen_SampleId as libc::c_int {
                    level = 3 as libc::c_int;
                    ({
                        let mut _temp: libc::c_ushort = 0;
                        if (*fapi).fread.expect("non-null function pointer")(
            ...
            if level == 3 as libc::c_int {
                ...
                if *hz != p2 {
                    ...
                    fluid_log!(
                        ...
                        CStr::from_ptr((*((*p).data as *const SFPreset)).name.as_ptr()).to_str().unwrap()
                    );
                    ({
                        let mut _temp: *mut fluid_list_t = p2;
                        p2 = if !p2.is_null() {
                ...
                fluid_log!(
                    ...
                    CStr::from_ptr((*((*p).data as *const SFInst)).name.as_ptr()).to_str().unwrap()
                );
                sfont_zone_delete(sf, hz, (*p2).data as *mut SFZone);
            }
            while !p3.is_null() {
                ...
                if size < 0 as libc::c_int {
                    return gerr!(
                        ErrCorr,
                        "Instrument generator chunk size mismatch",
                    );
                }
                if (*fapi).fseek.expect("non-null function pointer")(
                    fd,
...
unsafe extern "C" fn load_shdr(
        ...
        || size == 0 as libc::c_int as libc::c_uint
    {
        return gerr!(
            ErrCorr,
            "Sample header has invalid size",
        );
    }
    size = size
    ...
    i = 0 as libc::c_int as libc::c_uint;
    while i < size {
        p = malloc(::std::mem::size_of::<SFSample>() as libc::c_ulong) as *mut SFSample;
...
pub static mut badpgen: [libc::c_ushort; 14] = [
    Gen_StartAddrOfs as libc::c_int as libc::c_ushort,
    Gen_EndAddrOfs as libc::c_int as libc::c_ushort,
    Gen_StartLoopAddrOfs as libc::c_int as libc::c_ushort,
    Gen_EndLoopAddrOfs as libc::c_int as libc::c_ushort,
    Gen_StartAddrCoarseOfs as libc::c_int as libc::c_ushort,
    Gen_EndAddrCoarseOfs as libc::c_int as libc::c_ushort,
    Gen_StartLoopAddrCoarseOfs as libc::c_int as libc::c_ushort,
    Gen_Keynum as libc::c_int as libc::c_ushort,
    Gen_Velocity as libc::c_int as libc::c_ushort,
    Gen_EndLoopAddrCoarseOfs as libc::c_int as libc::c_ushort,
    Gen_SampleModes as libc::c_int as libc::c_ushort,
    Gen_ExclusiveClass as libc::c_int as libc::c_ushort,
    Gen_OverrideRootKey as libc::c_int as libc::c_ushort,
    0 as libc::c_int as libc::c_ushort,
];
...
pub unsafe extern "C" fn sfont_close(mut sf: *mut SFData, mut fapi: *mut fluid_fileapi_t) {
    ...
    if !(*sf).fname.is_null() {
        free((*sf).fname as *mut libc::c_void);
    }
    p = (*sf).info;
    while !p.is_null() {
        free((*p).data);
    ...
    (*sf).preset = 0 as *mut fluid_list_t;
    p = (*sf).inst;
    while !p.is_null() {
        p2 = (*((*p).data as *mut SFInst)).zone;
        while !p2.is_null() {
    ...
    (*sf).sample = 0 as *mut fluid_list_t;
...
pub unsafe extern "C" fn sfont_zone_delete(
    mut sf: *mut SFData,
    mut zlist: *mut *mut fluid_list_t,
    mut zone: *mut SFZone,
) {
...
#[no_mangle]
pub unsafe extern "C" fn gen_valid(mut gen: libc::c_int) -> libc::c_int {
...
#[no_mangle]
pub unsafe extern "C" fn gen_validp(mut gen: libc::c_int) -> libc::c_int {
    let mut i: libc::c_int = 0 as libc::c_int;
    if gen_valid(gen) == 0 {
        return 0 as libc::c_int;
    }
