...
pub type LogFn = Option<unsafe fn(_: i32, _: *mut i8, _: *mut libc::c_void) -> ()>;
...
pub unsafe fn fluid_set_log_function(level: i32, fun: LogFn, data: *mut libc::c_void) -> LogFn {
...
pub unsafe fn fluid_default_log_function(_level: i32, _message: *mut i8, _data: *mut libc::c_void) {
}
