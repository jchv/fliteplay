...
use crate::ll::channel::delete_fluid_channel;
use crate::ll::channel::fluid_channel_cc;
use crate::ll::channel::fluid_channel_get_banknum;
use crate::ll::channel::fluid_channel_get_num;
use crate::ll::channel::fluid_channel_get_preset;
use crate::ll::channel::fluid_channel_get_prognum;
use crate::ll::channel::fluid_channel_get_sfontnum;
use crate::ll::channel::fluid_channel_pitch_bend;
use crate::ll::channel::fluid_channel_pitch_wheel_sens;
use crate::ll::channel::fluid_channel_pressure;
use crate::ll::channel::fluid_channel_reset;
use crate::ll::channel::fluid_channel_set_banknum;
use crate::ll::channel::fluid_channel_set_interp_method;
use crate::ll::channel::fluid_channel_set_preset;
use crate::ll::channel::fluid_channel_set_prognum;
use crate::ll::channel::fluid_channel_set_sfontnum;
use crate::ll::channel::Channel;
use crate::ll::channel::new_fluid_channel;
use crate::ll::chorus::delete_fluid_chorus;
use crate::ll::chorus::fluid_chorus_get_depth_ms;
use crate::ll::chorus::fluid_chorus_get_level;
use crate::ll::chorus::fluid_chorus_get_nr;
use crate::ll::chorus::fluid_chorus_get_speed_Hz;
use crate::ll::chorus::fluid_chorus_get_type;
use crate::ll::chorus::fluid_chorus_processmix;
use crate::ll::chorus::fluid_chorus_processreplace;
use crate::ll::chorus::fluid_chorus_reset;
use crate::ll::chorus::fluid_chorus_set_depth_ms;
use crate::ll::chorus::fluid_chorus_set_level;
use crate::ll::chorus::fluid_chorus_set_nr;
use crate::ll::chorus::fluid_chorus_set_speed_Hz;
use crate::ll::chorus::fluid_chorus_set_type;
use crate::ll::chorus::Chorus;
use crate::ll::chorus::fluid_chorus_update;
use crate::ll::chorus::new_fluid_chorus;
use crate::ll::conv::fluid_conversion_config;
use crate::ll::defsfont::new_fluid_defsfloader;
use crate::ll::dsp_float::fluid_dsp_float_config;
use crate::ll::gen::fluid_gen_scale;
use crate::ll::hash::HashTable;
use crate::ll::list::delete_fluid_list;
use crate::ll::list::fluid_list_insert_at;
use crate::ll::list::fluid_list_nth;
use crate::ll::list::fluid_list_prepend;
use crate::ll::list::fluid_list_remove;
use crate::ll::list::fluid_list_size;
use crate::ll::list::List;
use crate::ll::modulator::fluid_mod_set_amount;
use crate::ll::modulator::fluid_mod_set_dest;
use crate::ll::modulator::fluid_mod_set_source1;
use crate::ll::modulator::fluid_mod_set_source2;
use crate::ll::modulator::fluid_mod_t;
use crate::ll::reverb::delete_fluid_revmodel;
use crate::ll::reverb::fluid_revmodel_getdamp;
use crate::ll::reverb::fluid_revmodel_getlevel;
use crate::ll::reverb::fluid_revmodel_getroomsize;
use crate::ll::reverb::fluid_revmodel_getwidth;
use crate::ll::reverb::fluid_revmodel_processmix;
use crate::ll::reverb::fluid_revmodel_processreplace;
use crate::ll::reverb::fluid_revmodel_reset;
use crate::ll::reverb::fluid_revmodel_setdamp;
use crate::ll::reverb::fluid_revmodel_setlevel;
use crate::ll::reverb::fluid_revmodel_setroomsize;
use crate::ll::reverb::fluid_revmodel_setwidth;
use crate::ll::reverb::ReverbModel;
use crate::ll::reverb::new_fluid_revmodel;
use crate::ll::settings::fluid_settings_getint;
use crate::ll::settings::fluid_settings_getnum;
use crate::ll::settings::fluid_settings_getstr;
use crate::ll::settings::fluid_settings_register_int;
use crate::ll::settings::fluid_settings_register_num;
use crate::ll::settings::fluid_settings_register_str;
use crate::ll::settings::fluid_settings_setint;
use crate::ll::settings::fluid_settings_setnum;
use crate::ll::settings::fluid_settings_setstr;
use crate::ll::settings::fluid_settings_str_equal;
use crate::ll::sfont::Preset;
use crate::ll::sfont::Sample;
use crate::ll::sfont::SoundfontLoader;
use crate::ll::sfont::SoundFont;
use crate::ll::sys::fluid_error;
use crate::ll::sys::fluid_sys_config;
use crate::ll::tuning::fluid_tuning_get_name;
use crate::ll::tuning::fluid_tuning_set_all;
use crate::ll::tuning::fluid_tuning_set_name;
use crate::ll::tuning::fluid_tuning_set_octave;
use crate::ll::tuning::fluid_tuning_set_pitch;
use crate::ll::tuning::Tuning;
use crate::ll::tuning::new_fluid_tuning;
use crate::ll::voice::delete_fluid_voice;
use crate::ll::voice::FluidVoiceAddMod;
use crate::ll::voice::fluid_voice_get_channel;
use crate::ll::voice::fluid_voice_get_id;
use crate::ll::voice::fluid_voice_init;
use crate::ll::voice::fluid_voice_is_playing;
use crate::ll::voice::fluid_voice_kill_excl;
use crate::ll::voice::fluid_voice_modulate;
use crate::ll::voice::fluid_voice_modulate_all;
use crate::ll::voice::fluid_voice_noteoff;
use crate::ll::voice::fluid_voice_off;
use crate::ll::voice::fluid_voice_set_gain;
use crate::ll::voice::fluid_voice_set_param;
use crate::ll::voice::fluid_voice_start;
use crate::ll::voice::fluid_voice_t;
use crate::ll::voice::fluid_voice_write;
use crate::ll::voice::new_fluid_voice;
use std::ffi::CStr;
...
pub struct fluid_synth_t {
    ...
    pub loaders: *mut List,
    pub sfont: *mut List,
    pub sfont_id: libc::c_uint,
    pub bank_offsets: *mut List,
    pub gain: f64,
    ...
    pub tuning: *mut *mut *mut Tuning,
    pub cur_tuning: *mut Tuning,
...
#[no_mangle]
pub unsafe extern "C" fn fluid_synth_settings(mut settings: *mut Settings) {
...
pub unsafe extern "C" fn new_fluid_synth(
    ...
    (*synth).min_note_length_ticks =
        (i as f64 * (*synth).sample_rate / 1000.0f32 as f64) as libc::c_uint;
    fluid_settings_register_num(
        settings,
        b"synth.gain\x00" as *const u8 as *const libc::c_char,
        0.2f32 as f64,
    ...
    (*synth).channel = libc::malloc(
        ((*synth).midi_channels as libc::size_t)
            .wrapping_mul(::std::mem::size_of::<*mut Channel>() as libc::size_t),
    ) as *mut *mut Channel;
...
unsafe extern "C" fn fluid_synth_sysex_midi_tuning(
    ...
    let mut prog;
    let mut channels;
    let mut tunedata: [f64; 128] = [0.; 128];
        ...
        0 | 3 => {
            ...
            *fresh13 = prog as libc::c_char;
            ...
            while i < 128 as libc::c_int {
                ...
                frac = (((tunedata[i as usize] - note as f64 * 100.0f64) * 16384.0f64
                    + 50.0f64)
        ...
        2 | 7 => {
            ...
            while i < count {
                ...
                if !(note == 0x7f as libc::c_int && frac == 16383 as libc::c_int) {
                    tunedata[index as usize] = note as f64 * 100.0f64
                        + frac as f64 * 100.0f64 / 16384.0f64;
                    index += 1
                }
                i += 1
            }
        ...
        8 | 9 => {
            ...
            if msgid == MIDI_SYSEX_TUNING_OCTAVE_TUNE_1BYTE as libc::c_int {
                ...
                while i < 12 as libc::c_int {
                    ...
                    tunedata[i as usize] = (frac - 64 as libc::c_int) as f64;
                    i += 1
                }
            } else {
                i = 0 as libc::c_int;
...
pub unsafe extern "C" fn fluid_synth_set_chorus(
    ...
    fluid_chorus_set_level((*synth).chorus, level as f32);
    fluid_chorus_set_speed_Hz((*synth).chorus, speed as f32);
    fluid_chorus_set_depth_ms((*synth).chorus, depth_ms as f32);
...
pub unsafe extern "C" fn fluid_synth_nwrite_float(
    ...
    let mut left_in: *mut *mut f32 = (*synth).left_buf;
    let mut right_in: *mut *mut f32 = (*synth).right_buf;
    let mut i;
    let mut num;
    let mut available;
    let mut count;
...
pub unsafe extern "C" fn fluid_synth_write_float(
    ...
    let mut left_in: *mut f32 = *(*synth).left_buf.offset(0 as libc::c_int as isize);
    let mut right_in: *mut f32 = *(*synth).right_buf.offset(0 as libc::c_int as isize);
    if (*synth).state != FLUID_SYNTH_PLAYING as libc::c_int as libc::c_uint {
        return 0 as libc::c_int;
    }
    l = (*synth).cur;
...
pub unsafe extern "C" fn fluid_synth_free_voice_by_kill(
    ...
    while i < (*synth).polyphony {
        ...
        if (*voice).volenv_section != FLUID_VOICE_ENVATTACK as libc::c_int {
            this_voice_prio = (this_voice_prio as f64
                + (*voice).volenv_val as f64 * 1000.0f64)
                as f32
        }
...
pub unsafe extern "C" fn fluid_synth_kill_by_exclusive_class(
    ...
    let mut excl_class: libc::c_int = ((*new_voice).gen[GEN_EXCLUSIVECLASS as libc::c_int as usize]
        .val as f32
        + (*new_voice).gen[GEN_EXCLUSIVECLASS as libc::c_int as usize].mod_0 as f32
        + (*new_voice).gen[GEN_EXCLUSIVECLASS as libc::c_int as usize].nrpn as f32)
        as libc::c_int;
...
pub unsafe extern "C" fn fluid_synth_add_sfloader(
    mut synth: *mut fluid_synth_t,
    mut loader: *mut SoundfontLoader,
) {
...
pub unsafe extern "C" fn fluid_synth_sfunload(
    ...
    let mut sfont: *mut SoundFont = fluid_synth_get_sfont_by_id(synth, id);
    if sfont.is_null() {
...
pub unsafe extern "C" fn fluid_synth_get_chorus_level(
    ...
    return fluid_chorus_get_level((*synth).chorus) as f64;
}
#[no_mangle]
pub unsafe extern "C" fn fluid_synth_get_chorus_speed_Hz(
    mut synth: *mut fluid_synth_t,
) -> f64 {
    return fluid_chorus_get_speed_Hz((*synth).chorus) as f64;
}
#[no_mangle]
pub unsafe extern "C" fn fluid_synth_get_chorus_depth_ms(
    mut synth: *mut fluid_synth_t,
) -> f64 {
    return fluid_chorus_get_depth_ms((*synth).chorus) as f64;
}
#[no_mangle]
...
pub unsafe extern "C" fn fluid_synth_create_key_tuning(
    ...
    let mut tuning: *mut Tuning = fluid_synth_create_tuning(synth, bank, prog, name);
    if tuning.is_null() {
        return FLUID_FAILED as libc::c_int;
    }
    if !pitch.is_null() {
...
pub unsafe extern "C" fn fluid_synth_tuning_dump(
    ...
    let mut tuning: *mut Tuning = fluid_synth_get_tuning(synth, bank, prog);
    if tuning.is_null() {
        return FLUID_FAILED as libc::c_int;
    }
    if !name.is_null() {
    ...
    if !pitch.is_null() {
        libc::memcpy(
            ...
            &mut *(*tuning)
                .pitch
                .as_mut_ptr()
                .offset(0 as libc::c_int as isize) as *mut f64
...
pub unsafe extern "C" fn fluid_synth_get_bank_offset0(
    ...
    let mut list: *mut List = (*synth).bank_offsets;
    let mut offset;
    while !list.is_null() {
